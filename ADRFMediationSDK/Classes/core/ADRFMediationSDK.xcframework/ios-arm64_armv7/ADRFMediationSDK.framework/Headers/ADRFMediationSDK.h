...
//  Updated by suancai on 2023/12/07 19:12.
//
...
/**
 是否开启个性化广告；默认YES，建议初始化SDK之前设置（支持平台：天目、然峰ads、穿山甲、优量汇、百度、快手）
 */
...
/**
 ...
 @param platformName 指定加载的平台 Eg:toutiao,gdt,baidu,ksad,tianmu,ranfeng
 */
